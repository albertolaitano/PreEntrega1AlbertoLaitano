            ...
            <div className="container">
                <div className="row">
                    <div className="col text-center">
                        ...
                        <Link to={"/"} className="btn btn-success my-5">Volver a la Pagina Principal</Link>
                    </div>
                </div>
            </div>
        )
                ...
                <div className="row">
                    <div className="col text-center">
                        <table className="table">
                            <tbody>
                                <tr>
                                <td className="text-end align-middle" colSpan={6}><a href="#" onClick={clear} className="btn btn-success">Limpiar Carrito<img src={trash} alt="Eliminar Producto" title="Eliminar Producto" /></a></td>
                                </tr>
                                {cart.map(product =>
                                <tr key={product.id}>
